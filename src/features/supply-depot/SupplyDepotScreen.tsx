...
export function SupplyDepotScreen() {
  ...
  function openTalk() { const trust = getNpcTrustRecord(activeSave, "pella_mosswick"); setMessage(trust.level >= 3 ? "Pella grins. 'You are becoming one of my regulars. That means I can start keeping a few things aside before other ranchers clean me out.'" : "Pella taps the counter. 'A rancher who stocks up before trouble is a rancher who sleeps better. Remember that.'"); setDepotMode("talk"); }
...
function PellaTrustPanel({ save, onBack, onShop }: { save: GameSave; onBack: () => void; onShop: (shelf?: DepotShelf) => void }) {
