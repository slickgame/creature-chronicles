...
const LOCATIONS: TownLocation[] = [
  ...
  { id: "battle-outfitter", title: "Battle Outfitter", badge: "Combat Prep", description: "Visit Daria Voss for early combat stock: equipment, manuals, consumables, and team-prep kits.", imageSrc: TOWN_ICONS.battleOutfitter, x: 84, y: 50, width: 10 },
  { id: "coliseum", title: "Coliseum Exhibition", badge: "3v3 Tactical AI", description: "Choose three creatures and command a target-first 3v3 exhibition against Basic, Tactical, or Champion enemy AI.", imageSrc: TOWN_ICONS.coliseum, x: 57, y: 45, width: 12 },
...
export function TownScreen() {
  ...
  const [message, setMessage] = useState("Welcome to town. The Coliseum Exhibition now supports deterministic Basic, Tactical, and Champion AI.");
