...
const LOCATIONS: TownLocation[] = [
  ...
  { id: "coliseum", title: "Coliseum Exhibition", badge: "3v3 Battle", description: "Choose three creatures and command a target-first 3v3 exhibition using their persistent equipped moves.", imageSrc: TOWN_ICONS.coliseum, x: 57, y: 45, width: 12 },
...
export function TownScreen() {
  ...
  const [message, setMessage] = useState("Welcome to town. The Coliseum Exhibition is open for target-first 3v3 battles.");
