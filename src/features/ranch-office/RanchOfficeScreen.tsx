...
export function RanchOfficeScreen() {
  ...
  const [message, setMessage] = useState("Welcome to the Ranch Office. Field Hauling now provides Materials for ranch upgrades.");
    ...
    <main className={styles.screen}>
      <section className={styles.frame}>
        ...
        <header className={styles.header}>
          <div>
            <p className={styles.kicker}>M14 Ranch Office</p>
        ...
        {showHelp ? <div className={styles.modalBackdrop} role="presentation" onClick={() => setShowHelp(false)}><section className={styles.resultModal} role="dialog" aria-modal="true" onClick={(event) => event.stopPropagation()}><img src={RANCH_UPGRADE_ASSETS.ranchLedger} alt="" /><p className={styles.kicker}>Ranch Office Help</p><h2>How Upgrades Work</h2><ul className={styles.helpList}><li>Use the left ledger tabs to switch between overview, habitats, nursery, breeding pen, and recovery upgrades.</li><li>All five habitat families have capacity upgrades: Feline, Canine, Bovine, Lapine, and Equine.</li><li>Upgrades can now cost Gold, GP, and Ranch Materials.</li><li>Assign Field Hauling before sleep to produce Materials for upgrades and future repairs.</li><li>Habitat and nursery capacity upgrades apply immediately.</li></ul><p className={styles.message}>{message}</p><button type="button" className={styles.primaryButton} onClick={() => setShowHelp(false)}>Got It</button></section></div> : null}
