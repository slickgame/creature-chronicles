...
type BuildingId = "house" | "office" | "feline" | "canine" | "bovine" | "lapine" | "equine" | "breeding" | "nursery" | "town" | "guild";
type Building = { id: BuildingId; title: string; milestone: "Available" | "M3" | "M4" | "M5" | "M6" | "M7" | "M11" | "M13"; description: string; actionLabel: string; imageSrc: string; x: number; y: number; width: number };
...
const BUILDINGS: Building[] = [
  ...
  { id: "bovine", title: "Bovine Habitat", milestone: "M13", description: "Home for Cow, Minotaur, Moon Yak, and future ranch-production creatures.", actionLabel: "Open Habitat", imageSrc: "/images/creatures/bovine/cow_portrait.png", x: 17, y: 78, width: 8 },
  { id: "lapine", title: "Lapine Habitat", milestone: "M13", description: "Home for Bunny, Antlerhare, Dream Lop, and future garden or nursery creatures.", actionLabel: "Open Habitat", imageSrc: "/images/creatures/lapine/bunny_portrait.png", x: 71, y: 78, width: 7 },
  { id: "equine", title: "Equine Habitat", milestone: "M13", description: "Home for Horse, Unicorn, Nightmare, and future travel or field creatures.", actionLabel: "Open Habitat", imageSrc: "/images/creatures/equine/horse_portrait.png", x: 84, y: 66, width: 8 },
...
function isAvailableBuilding(id: BuildingId): boolean { return id === "house" || id === "office" || id === "feline" || id === "canine" || id === "bovine" || id === "lapine" || id === "equine" || id === "breeding" || id === "nursery" || id === "town"; }
...
export function RanchHubScreen() {
  ...
  function handleSleep() { const result = advanceDay(); if (!result) return; setDaySummary(result); setModalMode("day-summary"); }
