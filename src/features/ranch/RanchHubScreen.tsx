...
const BUILDINGS: Building[] = [
  ...
  { id: "jobs", title: "Ranch Jobs", milestone: "M14", description: "Assign creatures to daily ranch work such as security, comfort, production, garden tending, and hauling.", actionLabel: "Open Jobs", imageSrc: "/images/buildings/ranch/guild_board.png", x: 60, y: 58, width: 8 },
