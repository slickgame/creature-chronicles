...
export const TRAINING_UPGRADES: TrainingUpgrade[] = [
  { upgradeId: "training_yard_upgrade", name: "Upgrade Training Yard", description: "Rebuild the yard with better lanes, safer weights, and recovery stations.", costGold: 350, materialCost: 8, iconPath: "/images/ui/icons/icon_training_xp.png", effectLabel: "Level Drill XP increases from 35 to 55." },
  { upgradeId: "coaching_bench_upgrade", name: "Upgrade Coaching Bench", description: "Adds better measurement tools and repeatable coaching routines.", costGold: 500, materialCost: 12, iconPath: "/images/ui/icons/icon_training_stats.png", effectLabel: "Stat Coaching chance increases from 18% to 25%." },
  { upgradeId: "assistant_trainer", name: "Hire Assistant Trainer", description: "An assistant coach lets Rhea supervise more than one creature at a time.", costGold: 650, materialCost: 16, iconPath: "/images/ui/icons/icon_training_whistle.png", effectLabel: "Training capacity increases from 1 creature to 2 creatures.", requiredUpgradeId: "training_yard_upgrade" },
